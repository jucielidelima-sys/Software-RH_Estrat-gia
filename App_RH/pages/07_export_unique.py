...
st.download_button("Exportar base completa em Excel", data=gerar_excel_export(cargos_df, maturidade_df, skills_df, pdi_df, avaliacoes_df), file_name="rh_estrategico_industrial.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
